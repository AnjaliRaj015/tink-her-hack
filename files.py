...
import os
import shutil
from const import DEFAULT_ERROR_MESSAGE, ATTACHMENT_MESSAGES
...
def temp_directory(directory_path):
    """
    take file in the given directory path
    """
